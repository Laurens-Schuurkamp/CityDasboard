...
function createDomains(){
  ...
  var subDomainA={id:"divv", label:"Transport & Infrastructure", icon:"images/svg/icon_divv.svg", graphData:dummyData, tickerData:tickerData};
  ...
  var subDomainB={id:"pt", label:"Public transport", icon:"images/svg/icon_pt.svg", graphData:dummyData, tickerData:tickerData};
	var properties={
	  index:0,
	  color:"#FDD0A2",
  ...
  subDomainA={id:"smartcitizen", label:"Smartcitizen", icon:"images/svg/icon_smartcitizen.svg", graphData:dummyData, tickerData:tickerData};
  dummyData=getDummyData();
  tickerData = [
      {discription: "NO2", value: "20.27"},
      {discription: "CO", value: "117.49"},
  ...
  subDomainB={id:"airqualities", label:"Air qualities", icon:"images/svg/icon_airquality.svg", graphData:dummyData, tickerData:tickerData};
  var properties={
	  index:1,
	  color:"#FFB27D",
	  mainDomain:mainDomain,
